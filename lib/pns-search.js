        ...
        template: '<div class="pns-search">'+
                        ...
                        '<div class="modal" id="{{modal_id}}">'+
                            '<div class="modal-content">'+
                                ...
                                '<div class="moreTitle">'+
                                    '<label class="label">'+
                                        '<input type="checkbox" ng-click="moreChangeAll($event)" style="position: relative;top: 2px;">'+
        ...
        link: function (scope, element, attr) {
            $rootScope.layPromise.then(function (layui) {
                ...
                scope.getHightSearch = function(){
                    var hightSearchList = sessionFactory.get("ReqOldBackTaskQueryParam");
                    ...
                    var keyName = $location.path();
                    if(!hightSearchList[keyName]){
                        httpService.request({
                            method: "get",
                            ...
                            if (res.code == 200) {
                                ...
                                hightSearchList[keyName] = res.data;
                                sessionFactory.put("ReqOldBackTaskQueryParam",JSON.stringify(hightSearchList));
                            }
                        })
                    } else {
                        scope.menuFilter(hightSearchList[keyName]);
                    }
