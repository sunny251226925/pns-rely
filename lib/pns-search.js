    ...
    return {
        ...
        template: '<div class="pns-search">'+
                        ...
                        '<div class="modal" id="{{modal_id}}">'+
                            '<div class="modal-content">'+
                                ...
                                '<div class="moreTitle">'+
                                    '<label class="label">'+
                                        '<input type="checkbox" ng-model="moreChangeChecked" ng-click="moreChangeAll()">'+
        ...
        link: function (scope, element, attr) {
            $rootScope.layPromise.then(function (layui) {
                ...
                //更多条件 全选
                scope.moreChangeAll = function(){
                    for(var i=0; i<scope.modal_moreList.length; i++){
                        scope.modal_moreList[i].show = !scope.moreChangeChecked;
                    }
                    if(!scope.moreChangeChecked){
                ...
                scope.save = function(){
                    ...
                    var code = "";
                    for(var i=0; i<scope.modal_moreList.length; i++){
                        code = scope.modal_moreList[i].code;
                        scope.params[code] = "";
