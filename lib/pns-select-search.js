    ...
    return {
        ...
        template: '<div class="pns-ng-select">' +
                        ...
                        '<div class="select-list-box" ng-show="listShow">'+
                            '<ul class="list" ng-click="change({item:item})">' +
                                ...
                                '<li ng-if="selectList.length > 0" class="item" ng-class="{active: v.value==item.value}" ng-repeat="v in selectList" ng-mousedown="selectChange(v)" ng-bind="v.name"></li>'+   
                            '</ul>' +
        ...
        link: function(scope,element,attrs) {
            ...
            scope.selectChange = function(val){
                ...
                scope.key = val.value;
                scope.change({page:scope.page,name:val.name});
            }
