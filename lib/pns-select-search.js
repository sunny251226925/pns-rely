    ...
    return {
        ...
        template: '<div class="pns-ng-select">' +
                        '<div class="select-input" ng-click="selectClick()">' +
                            '<input ng-model="item.name" ng-if="validate" class="input" type="text" pns-validate validate-regex="{{validateRegex}}" placeholder="{{input_placeholder}}" ng-keyup="selectKeyup()" ng-blur="selectBlur()">'+
                        ...
                        '</div>'+
                        '<ul class="select-list" ng-show="listShow" ng-click="change({item:item})">' +
