                        ...
                        '<thead class="thead">'+
                            '<tr class="tr">'+
                                ...
                                '<th class="th" ng-repeat="item in header" ng-style="{width: item.width}" ng-class="{\'width-min\':item.isType==\'checkbox\'}">'+
                                    '<div class="title" ng-if="item.isType==\'checkbox\'"></div>'+
                        ...
                        '<tbody class="tbody">' +
                            '<tr class="tr" ng-repeat="item in list">' +
                                ...
                                '<td class="td" ng-repeat="key in header track by $index">' +
                                    '<div class="title" ng-if="key.isType==\'checkbox\'" style="width:50px" ng-click="key.change(item)" ><input type="checkbox" ng-model="item.status" ng-checked="item.status"></div>' +
