...
(function (window, angular){ 
    ...
    .directive('pnsSearch', ["$rootScope", "httpService","sessionFactory", "$location","$compile", function ($rootScope, httpService, sessionFactory, $location, $compile) {
        return pns_search($rootScope, httpService, sessionFactory, $location, $compile);
    }])
